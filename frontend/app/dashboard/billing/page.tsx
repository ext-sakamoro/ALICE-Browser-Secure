...
const plans = [
  { name: 'Free', price: '$0/mo', features: ['100 scans/day', 'Basic threat detection', 'Ad blocking', 'Community support'] },
  { name: 'Pro', price: '$29/mo', features: ['5,000 scans/day', 'Deep scan mode', 'Custom blocklists', 'API access', 'Priority support'] },
  { name: 'Enterprise', price: 'Custom', features: ['Unlimited scans', 'Compliance reports', 'Custom rules engine', 'SLA guarantee', 'Dedicated support'] },
];
